...
class testForDay2Part2{
    ...
    @Test
    fun testDetermineResponse(){
        val opponentMove = 'A'
        val desiredOutcome = 'Y'

        val expectedRes = 'X'
        val resultat = determineResponse(opponentMove, desiredOutcome)

        assertEquals(expectedRes, resultat)
